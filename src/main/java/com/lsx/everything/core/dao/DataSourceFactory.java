...
public class DataSourceFactory {
        ...
        if(dataSource == null){
            synchronized (DataSourceFactory.class){
                if(dataSource == null){
                    ...
                    dataSource.setUrl("jdbc:h2:"+workDir+File.separator+"everything_l");
                }
            }
        }
        return dataSource;
    ...
    public static void initDatabase(){
        ...
        //try-with-resources
        try (InputStream in = DataSourceFactory.class.getClassLoader().getResourceAsStream("everything_l.sql");)
        {
            if(in == null){
...
//        // 绝对路径： /Users/lsx/IdeaProjects/everything-lsx/src/main/resources/everything_lsx.sql
//        //try-with-resources
//        InputStream in = DataSourceFactory.class.getClassLoader().getResourceAsStream("everything_l");
//
//        //3.获取数据库连接和名称，执行SQL
//        //3.1获取数据库的连接
//        // 3.2创建命令
